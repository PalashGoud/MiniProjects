...
function Clock() {
  ...
  return (
    <div className='flex cursor-pointer h-[100vh] bg-[#171517] relative items-center justify-center'>
      ...
      <div className='clock w-[440px] h-[440px] rounded-full relative border-[white] border-[2px] text-[white] bg-[#171517] flex items-center justify-center'>
        ...
        <div style={{ transform: `rotate(${hour * 30 + minutes / 2}deg)`, transformOrigin: 'bottom' }}
          className='h-[80px] w-[7px] rounded-md bg-[#355894] absolute bottom-[50%]'></div>

        <div style={{ transform: `rotate(${6 * minutes}deg)`, transformOrigin: 'bottom' }}
          className='h-[120px] w-[5px] rounded-sm bg-[#2ba4c3] absolute bottom-[50%]'></div>

        <div style={{ transform: `rotate(${6 * seconds}deg)`, transformOrigin: 'bottom' }}
          className='h-[150px] w-[3px] rounded-sm bg-[#10f7ec] absolute bottom-[50%]'></div>
      </div>
